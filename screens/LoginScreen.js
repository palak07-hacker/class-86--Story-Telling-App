...
import { StyleSheet, View, Button, Image, Text, SafeAreaView, Platform, StatusBar, RFValue, TouchableOpacity} from "react-native";
    ...
    if (!this.state.fontsLoaded) {
      ...
      return (
        <View style={styles.container}>
          ...
          <Text style={styles.googleText}>Sign In With Google
           </Text>
           </TouchableOpacity>
           </View>
